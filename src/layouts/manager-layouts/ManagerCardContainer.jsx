...
function ManagerCardContainer() {
    let Report = <NavLink to='/manager/report'><img src={report} alt="Report" width="150" height="120" /></NavLink>
  return (
            ...
            <Container fluid>
                ...
                <Col  className="inner_leave_block d-flex flex-wrap flex-lg-wrap flex-xl-nowrap flex-sm-wrap flex-lg-wrap justify-content-lg-evenly justify-content-between justify-content-xl-between p-2 body-bg-color flex-grow-1 justify-content-sm-evenly">
                    <Container fluid className='d-flex flex-wrap flex-sm-wrap justify-content-md-between justify-content-around p-2 '>
                        {/* <SelectDate/> */}
                        <CardComponent title="Team Members" count={25} content="Members" />
                        <CardComponent title="Pending Requests" count={12} content="Requests" />
                        <CardComponent title="On Leave" count={9} content="Members" />
...
export default ManagerCardContainer